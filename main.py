...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_FVA+0",
            ...
            "sample_method": "No-Deterministic+kim_FVA+16",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+kim_FVA+32",
            ...
            "sample_method": "No-Deterministic+kim_FVA+64",
