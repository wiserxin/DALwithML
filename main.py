...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "sample_method": "Deterministic+kim_VRS_TA_3per+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "Deterministic+kim_VRS+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "Deterministic+kim_VRS_TA_3per+64",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 64,
            "sample_method": "Deterministic+kim_VRS+64",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+kim_VRS_TA_3per+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS_TA_3per+32",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+kim_VRS_TA_1per+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "Deterministic+kim_VRS_TA_1per+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS_TA_1per+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 64,
            "sample_method": "Deterministic+kim_VRS_TA_1per+64",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+kim_VRS_TA_2per+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "Deterministic+kim_VRS_TA_2per+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS_TA_2per+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 64,
            "sample_method": "Deterministic+kim_VRS_TA_2per+64",
        }
