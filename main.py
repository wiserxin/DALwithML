...
def main(args):
    ...
    task_seq = [
        ...
        #     "sample_method": "Deterministic+SIM+0",
            ...
            # "acquire_question_num_per_round": 1200,
            # "warm_start_random_seed": 0,
            # "sample_method": "No-Deterministic+kim_MVL4+0",

            "model_name": "CNN",
            "group_name": "[slabs]agnews+F1",
            "max_performance": 0.90,
            "data_path": "../../datasets/ag_news/",
            "acquire_method": "no-dete",
            "sub_acquire_method": "RKL",
            "unsupervised_method": 'submodular',
            "submodular_k": 2,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_RKL+0",
        }, {
            ...
            "sample_method": "No-Deterministic+kim_RKL+16",
        }, {
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+kim_RKL+32",
        }, {
            ...
            "sample_method": "No-Deterministic+kim_RKL+64",
        },{
            "model_name": "CNN",
            "group_name": "[slabs]agnews+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_MVL+0",
        }, {
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+kim_MVL+16",
        }, {
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+kim_MVL+32",
        }, {
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 64,
            "sample_method": "No-Deterministic+kim_MVL+64",
        },{
            "model_name": "CNN",
            "group_name": "[slabs]agnews+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_MVL3+0",
        }, {
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+kim_MVL3+16",
        }, {
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+kim_MVL3+32",
        }, {
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 64,
            "sample_method": "No-Deterministic+kim_MVL3+64",
