...
def main(args):
    ...
    task_seq = [
        ...
        #     "sample_method": "Deterministic+SIM+0",
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+FERKL3e4+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]???+RCV1+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+RKL3e4+0",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]???+RCV1+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+FERKL3e4+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]???+RCV1+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+RKL3e4+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]???+RCV1+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "No-Deterministic+FERKL3e4+64",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]???+RCV1+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 64,
            "sample_method": "No-Deterministic+RKL3e4+64",
