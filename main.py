...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_LIW+0",
            ...
            "sample_method": "No-Deterministic+kim_LIW+16",
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+kim_LIW+32",
            ...
            "sample_method": "No-Deterministic+kim_LIW+64",
