...
def main(args):
    ...
    task_seq = [
        ...
        #     "sample_method": "Deterministic+SIM+0",
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+DRL+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]KIM+???+3e4trn+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "No-Deterministic+DRL+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]KIM+???+3e4trn+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "No-Deterministic+DRL+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]KIM+???+3e4trn+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "No-Deterministic+DRL+64",
