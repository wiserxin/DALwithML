...
def main(args):
    ...
    task_seq = [
        ...
        # }, {
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+FELplusRKL+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]KIM+???+3e4trn+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "No-Deterministic+FELplusRKL+16",
        }, {
            ...
            "sample_method": "No-Deterministic+FELplusRKL+32",
        }, {
            ...
            "sample_method": "No-Deterministic+FELplusRKL+64",
        },
