...
def main(args):
    ...
    task_seq = [
...

        {
            ...
            "acquire_question_num_per_round": 200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+halfDAL+0",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]CNN+DAL+1e4trn",
            "max_performance": 0.80,
            ...
            "acquire_question_num_per_round": 200,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+halfDAL+16",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]CNN+DAL+1e4trn",
            "max_performance": 0.80,
            ...
            "sample_method": "No-Deterministic+halfDAL+32",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]CNN+DAL+1e4trn",
            "max_performance": 0.80,
            ...
            "acquire_question_num_per_round": 200,
            "warm_start_random_seed": 64,
            "sample_method": "No-Deterministic+halfDAL+64",
        },
