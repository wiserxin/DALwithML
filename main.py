...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_FERKL_A+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_FERKL_B+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_FERKL_C+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_FERKL_D+0",
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_FEL_A+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_FEL_B+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_FEL_C+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+kim_FEL_D+0",
        }
