...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "generated_percentage":"0.3",
            "num_acquisitions_round": 25,
            "init_question_num": 1200,
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+kim_VRS_TA_2per_0.3+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "using_generated_data":True,
            "generated_used_per_sample": 2,
            "generated_percentage":"0.5",
            "num_acquisitions_round": 25,
            "init_question_num": 1200,
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+kim_VRS_TA_2per_0.5+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "Deterministic+kim_VRS_TA_2per_0.3+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "Deterministic+kim_VRS_TA_2per_0.5+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS_TA_2per_0.3+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS_TA_2per_0.5+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "Deterministic+kim_VRS_TA_2per_0.3+64",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 64,
            "sample_method": "Deterministic+kim_VRS_TA_2per_0.5+64",
        }
