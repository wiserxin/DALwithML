...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "num_acquisitions_round": 73,
            "init_question_num": 1200,
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+kim_VRS_TA_400_2per+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "Deterministic+kim_VRS_TA_400_2per+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS_TA_400_2per+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "Deterministic+kim_VRS_TA_400_2per+64",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+kim_VRS_400+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 16,
            "sample_method": "Deterministic+kim_VRS_400+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS_400+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 64,
            "sample_method": "Deterministic+kim_VRS_400+64",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+kim_VRS_800+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 800,
            "warm_start_random_seed": 16,
            "sample_method": "Deterministic+kim_VRS_800+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 800,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS_800+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 800,
            "warm_start_random_seed": 64,
            "sample_method": "Deterministic+kim_VRS_800+64",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 800,
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+kim_VRS_TA_800_2per+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 800,
            "warm_start_random_seed": 16,
            "sample_method": "Deterministic+kim_VRS_TA_800_2per+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 800,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+kim_VRS_TA_800_2per+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 800,
            "warm_start_random_seed": 64,
            "sample_method": "Deterministic+kim_VRS_TA_800_2per+64",
