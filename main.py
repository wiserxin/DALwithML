...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "Deterministic+KIM_STD+0",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]stack+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "Deterministic+KIM_STD+16",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "Deterministic+KIM_STD+32",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]stack+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "Deterministic+KIM_STD+64",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]stack+F1",
            "max_performance": 0.90,
