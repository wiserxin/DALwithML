...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+KIM_VRS_EM1+0",
        },{
                        "model_name": "CNN",
            "group_name": "[mlabs]TA+nodete+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+KIM_VRS_EM1+16",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]TA+nodete+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+KIM_VRS_EM1+32",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]TA+nodete+stack+F1",
            "max_performance": 0.90,
            ...
            "sample_method": "No-Deterministic+KIM_VRS_EM1+64",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]TA+nodete+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 0,
            "sample_method": "No-Deterministic+KIM_VRS_TR1+0",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+nodete+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+KIM_VRS_TR1+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+nodete+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+KIM_VRS_TR1+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]TA+nodete+stack+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 64,
            "sample_method": "No-Deterministic+KIM_VRS_TR1+64",
        }
