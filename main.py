...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "sample_method": "No-Deterministic+kim_FERKL_A+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+kim_FEL_A+16",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+kim_VRS_A+16",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+kim_FERKL_A+32",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+kim_FEL_A+32",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 32,
            "sample_method": "No-Deterministic+kim_VRS_A+32",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "sample_method": "No-Deterministic+kim_FERKL_A+64",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 64,
            "sample_method": "No-Deterministic+kim_FEL_A+64",
        },{
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+dataDistribution",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 400,
            "warm_start_random_seed": 64,
            "sample_method": "No-Deterministic+kim_VRS_A+64",
