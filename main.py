...
def main(args):
    ...
    task_seq = [
        ...
        # },{
            ...
            "sample_method": "No-Deterministic+kim_RKL8.0+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+kim_RKL8.1+16",
        # }, {
        #     "model_name": "CNN",
        #     "group_name": "[mlabs]aapd+F1",
        #     "max_performance": 0.90,
        ...
        #     "acquire_question_num_per_round": 1200,
        #     "warm_start_random_seed": 16,
        #     "sample_method": "No-Deterministic+kim_RKL8.2+16",
        }, {
            "model_name": "CNN",
            "group_name": "[mlabs]aapd+F1",
            "max_performance": 0.90,
            ...
            "acquire_question_num_per_round": 1200,
            "warm_start_random_seed": 16,
            "sample_method": "No-Deterministic+kim_RKL8.3+16",
